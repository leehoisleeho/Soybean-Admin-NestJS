...
<template>
  ...
  <TransitionGroup tag="div" name="setting-list" class="flex-col-stretch gap-12px">
    ...
    <SettingItem key="4" :label="$t('theme.layout.header.fullScreen')">
      <NSwitch v-model:value="themeStore.header.fullScreen.visible" />
    </SettingItem>
    <SettingItem key="5" :label="$t('theme.layout.header.themeSchema')">
      <NSwitch v-model:value="themeStore.header.themeSchema.visible" />
    </SettingItem>
    <SettingItem key="6" :label="$t('theme.layout.header.themeButton')">
      <NSwitch v-model:value="themeStore.header.themeButton.visible" />
    </SettingItem>
  </TransitionGroup>
</template>
