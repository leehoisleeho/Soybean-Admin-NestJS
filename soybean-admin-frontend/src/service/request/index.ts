...
export const request = createFlatRequest(
  ...
  },
  {
    ...
    async onBackendFail(response, instance) {
      ...
      const responseMsg = typeof payload?.msg === 'string' ? payload.msg : '';
      ...
      if (modalLogoutCodes.includes(responseCode) && responseMsg && !request.state.errMsgStack?.includes(responseMsg)) {
